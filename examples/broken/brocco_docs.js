...
startDocs = my.startDocs = function() { 
    // setTimeout(function () { 
        toc(); minidocs.last=minidocs(docs); if (typeof console !== "undefined") console.log('starting', minidocs.last, docs, typeof toc, new Date() - tstart, arguments.length, arguments); 
    // }, 550);
};
minidocs(docs).hits || (typeof Rainbow !== "undefined" && Rainbow.color ? Rainbow.color(startDocs) : setTimeout(startDocs, 1000));
